...
fun main() {
    var parsedGrid = TextFileParser.parseLines("src/day11/input.txt") { line -> line.map { Spot(it) } }
    ...
    parsedGrid = TextFileParser.parseLines("src/day11/input.txt") { line -> line.map { Spot(it) } }
